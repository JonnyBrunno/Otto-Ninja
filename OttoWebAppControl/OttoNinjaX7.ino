...
// ======================= REDE (Wi-Fi) =======================
const char* ssid = "ssid";         // escreva o nome da sua rede Wi-Fi
const char* password = "password"; // escreva a senha da sua rede Wi-Fi

// Por padrão ele tentará usar este IP; se já estiver em uso, pegará outro livre.
// Você pode conferir qual IP o robô pegou abrindo o Serial Monitor.
